...
## 项目概述
这是一个现代化的 React 管理系统框架，基于 Next.js 15 和 Ant Design 开发，提供了完整的路由管理、状态管理和用户认证功能，支持多级菜单和子路由功能。

## 技术栈

- **React 19.1.0**
- **Next.js 15.5.4** (使用 Turbopack 加速) - 支持多级路由
- **Ant Design 5.27.4**
- **Redux Toolkit 2.9.0**
- **TypeScript 5**
- **Tailwind CSS 4**
...
1. 项目使用 Next.js 15 的 App Router 模式，请遵循相关的文件命名和组件结构规范
2. 确保所有路由配置中的 key 值唯一
3. 对于受保护的路由，确保用户已登录才能访问
4. 在开发新功能前，建议先了解现有代码结构和模式
